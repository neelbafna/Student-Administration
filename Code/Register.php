	...
	<div>
		...
		<table cellspacing="3" align="center" cellpadding="8">
			...
			<tr>
				...
				<td><input type="text" name="name" placeholder="Enter Name" pattern="[A-Za-z]*[A-Za-z]{3}" title="Valid Name" style="height:20px" /></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><input type="text" name="city" placeholder="Enter City" pattern="[A-Za-z]*[A-Za-z]{3}" title="Valid City Name" style="height:20px"/></td>
			</tr>
			<tr>
				<td><label>State</label></td>
				<td><input type="text" name="state" placeholder="Enter State" pattern="[A-Za-z]*[A-Za-z]{3}" title="Valid State Name" style="height:20px"/></td>
			</tr>
			<tr>
